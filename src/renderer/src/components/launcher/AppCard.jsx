    ...
    return (
        ...
        >
            ...
            <div style={{ minWidth: 0, flex: 1 }}>
                ...
                <div style={{ fontSize: 12, color: '#6b7280', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{app.built ? 'Built' : 'Draft'} · {(app.platforms || []).join(' + ')}</div>
            </div>
            <div style={{ display: 'flex', gap: 6, opacity: hover ? 1 : 0, transition: 'opacity .15s' }}>
                {app.path && (
                    <button
                        ...
                        title="Explore files on your computer"
                        className="nb-btn"
